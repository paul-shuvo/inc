...
WHERE task_assignment.ASSIGNED_TO = '$ASSIGNED_TO' AND task_assignment.DATE_ACCEPTED IS NULL";

$result = mysqli_query($conn,$query);
$response .= '
           <table id="pending-assignments" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
              <thead>
                <tr>

...
if(!$_SESSION['manager'] || $_SESSION['manager'] != $_SESSION['user'])
{
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- <li class=" dropdown"><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Tasks Assignment <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a class="replacediv" href="#">Pending Assignments</a></li>
                                <li><a class="replacediv" href="#">On Going Assignments</a></li>
                                <li><a class="replacediv" href="#">Completed Assignments</a></li>
                            </ul>
                        </li> -->
